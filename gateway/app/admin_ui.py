...
async function loadDisplay() {
  ...
  document.querySelector('#content').innerHTML = `<form id="display-form"><input type="hidden" name="profile_id"><div class="form-grid">
    <label>配置名称<input name="profile_name" required></label><label>宽度<input name="width_px" type="number" min="320" max="7680" value="1920" required></label><label>高度<input name="height_px" type="number" min="320" max="7680" value="1080" required></label>
    <label>方向<select name="orientation"><option value="landscape">横屏</option><option value="portrait">竖屏</option></select></label><label>缩放方式<select name="scale_mode"><option value="fit">fit</option><option value="fill">fill</option><option value="crop">crop</option></select></label>
    ...
    <label>字幕左安全区<input name="safe_left" type="number" min="0" max="0.45" step="0.01" value="0.08"></label><label>字幕右安全区<input name="safe_right" type="number" min="0" max="0.45" step="0.01" value="0.08"></label><label>字幕底部安全区<input name="safe_bottom" type="number" min="0" max="0.45" step="0.01" value="0.08"></label><label>字幕字号<input name="subtitle_font_px" type="number" min="12" max="240" value="52"></label>
