...
Knowledge demo gate: `TASK-020A(DONE) -> TASK-020B(DONE locally)`. The preserved TASK-014A demo database was not overwritten; production publication still waits for TASK-014H.
