...
- `TASK-014H`: `DONE`; DNS, HTTP `308`, public HTTPS health/readiness, TLS 1.3 SNI, public APK response and Certbot renewal dry-run all pass. Production readiness still reports real Doubao ASR/TTS/LLM/Embedding and v2.1 at 41 approved / 24 draft / 65 x 2048 vectors. Evidence: `docs/evidence/TASK-014H/demo-online-closeout-20260810.md`.
...
- `TASK-020C`: `PARTIAL` at its original task gate; Tencent production has the formal knowledge, approved MOV-derived video/background and bound default Profile. Its shared public HTTPS blocker was cleared by TASK-014H on 2026-08-12. Evidence: `docs/evidence/TASK-020C/production-knowledge-avatar-sharing-20260807.md`.
...
- `TASK-020F`: `DONE / PRODUCTION_PUBLISHED` historically; 25 authorized Aiye HTML files and the v2.2 package remain published and accepted. The latest Demo instruction activated v2.1 instead; v2.2 remains recoverable from `/opt/jiyangjia-ai/backups/task014h-demo-online-20260811T034331Z`. Evidence: `docs/evidence/TASK-020F/aiye-knowledge-v22-acceptance-20260809.md`.
...
Production domain gate: `TASK-014H(DONE)`; TASK-015 may now begin when a physical Android 12 device is available.

Knowledge demo gate: `TASK-020A(DONE) -> TASK-020B(DONE locally) -> TASK-020C(PARTIAL historical task result; shared HTTPS blocker cleared) -> TASK-020D(DONE public package / production re-import) -> TASK-020E(DONE / READY_FOR_DEMO) -> TASK-020F(DONE / v2.2 production published)`.
