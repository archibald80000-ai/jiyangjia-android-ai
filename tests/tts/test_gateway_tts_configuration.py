...
def test_gateway_reports_missing_doubao_tts_credentials(monkeypatch) -> None:
    ...
    for key in ("DOUBAO_TTS_APP_ID", "DOUBAO_TTS_ACCESS_TOKEN", "DOUBAO_TTS_TOKEN", "DOUBAO_TTS_KEY", "DOUBAO_TTS_VOICE_TYPE"):
    ...
    assert "DOUBAO_TTS_APP_ID" in detail["missing"]
    assert "DOUBAO_TTS_ACCESS_TOKEN" in detail["missing"]
    assert "DOUBAO_TTS_VOICE_TYPE" in detail["missing"]
