...
- `inspect_livetalking_assets.ps1`: verify a user-downloaded official Wav2Lip asset source before local preparation; supports the official model-share archive layout and Windows integrated package layout.
